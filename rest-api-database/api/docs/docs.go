...
const docTemplate = `{
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ProductApiResponse"
                        }
                    },
                    "default": {
                        "description": "",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ProductApiFindResponse"
                        }
                    },
                    "default": {
                        "description": "",
    ...
    "definitions": {
        ...
        "models.ProductApiFindResponse": {
            "type": "object",
            "properties": {
                "body": {
                    "$ref": "#/definitions/models.ProductFindResponse"
                },
                "error_code": {
                    "type": "integer"
                },
