...
import (
	...
	_ "github.com/golanguzb70/tracing-examples/rest-api-database/api/docs" // docs
	v1 "github.com/golanguzb70/tracing-examples/rest-api-database/api/handlers/v1"
	"github.com/golanguzb70/tracing-examples/rest-api-database/api/middleware"
...
func New(log *logger.Logger, cfg config.Config, strg storage.StorageI) *gin.Engine {
	...
	product.GET("/list", h.ProductFind)
	product.PUT("", h.ProductUpdate)
